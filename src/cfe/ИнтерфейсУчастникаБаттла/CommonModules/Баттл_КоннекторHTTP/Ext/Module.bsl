...
Функция ЧислоИзСтроки(Знач ИсходнаяСтрока, Знач Длина = 15, Знач Разрядность = 0) Экспорт
	
	ТипЧисло = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(Длина, Разрядность, ДопустимыйЗнак.Любой));
	Результат = ТипЧисло.ПривестиЗначение(Строка(ИсходнаяСтрока));
