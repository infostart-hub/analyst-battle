...
Функция ТекущийБаттл() Экспорт
	...
	ТекБаттл = Константы.ТекущийБаттл.Получить();
	
	Баттл = Новый Структура;
	Баттл.Вставить("Код", ТекБаттл.Код); 
	Баттл.Вставить("Наименование", ТекБаттл.Наименование);
	Баттл.Вставить("Участники", УчастникиБаттла(ТекБаттл));
